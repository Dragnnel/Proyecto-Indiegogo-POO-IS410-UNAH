 ...
 <div class="row">
    ...
    <div class="row">
      <div class="footer col-xl-12">
        ...
        <p>Al colaborar con las campañas —por aquí lo llamamos "patrocinar"— te unes a un grupo de conocedores y primeros adaptadores que añaden impulso a grandes proyectos en varias etapas del desarrollo, desde los primeros conceptos hasta productos listos para enviar.</p>
...
<div class="row">
      <div class="footer col-xl-12">
        ...
        <p>Los pedidos de Marketplace tienen envío garantizado – si un vendedor no cumple con su cronograma de envíos, te reembolsaremos la compra. La mayoría de los productos son campañas de crowdfunding exitosas, por lo que no hay un lugar mejor para encontrar innovaciones antes de que sean masivas.</p>
